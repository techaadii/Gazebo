...
#define NODE_MAIN_LOGGER_NAME "orchestrator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liborchestrator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<my_sim_tesi_ros2_nodes::OrchestratorNode>";
