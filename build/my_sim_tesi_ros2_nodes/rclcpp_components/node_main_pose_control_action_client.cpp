...
#define NODE_MAIN_LOGGER_NAME "pose_control_action_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<my_sim_tesi_ros2_nodes::PoseControlActionClient>";
