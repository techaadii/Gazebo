...
#define NODE_MAIN_LOGGER_NAME "pose_control_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<my_sim_tesi_ros2_nodes::PoseControlActionServer>";
